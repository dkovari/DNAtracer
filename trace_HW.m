function YX =trace_HW(IM,THRESHOLD)
%DNA tracing routine written by Haowei Wang.
...
%
% Usage:
%   XY = trace_HW(IM,THRESHOLD)
%
% Inputs:
%   IM: The image that should be traced.
%   
%   THRESHOLD: the value which specifies the level used to threshild IM
%   into a binary image.
%
% Output:
